    ...
    <>
      ...
      <Row className="mt-4">
        ...
        <Col className="text-end mt-3">
          <BackButton />
        </Col><hr style={{marginLeft:'140px',width:'1150px',color:'black',backgroundColor:'black'}}/>
      </Row>
          ...
          <Col md={6}>
            ...
            <section className='pt-5'>
              <Form onSubmit={handleSubmit} style={{ marginBottom: '80px', width: '120%', marginLeft: '200px' }}>
                <h3><b style={{fontSize:'24px'}}>Add Content</b></h3><hr />
              ...
              {isEditing && (
                <Button
                  ...
                  style={{
                    ...
                    position: 'relative',
                    top: '-15.9vh',
                    left: '23vw', backgroundColor: '#E01950'
                  }}
                  type="clear"
