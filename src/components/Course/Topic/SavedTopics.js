    ...
    return (
        <Container  fluid className='mt-1' style={divStyle}>
            {loading ? (
                ...
                topicsDetail.map((topic, index) => (
                    <Card key={index} style={{ marginBottom: '20px', justifyContent: 'space-between', marginTop: '20px', fontSize: '18px' ,width:'1400px'}}>
                        <Card.Header>
                            <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
                        ...
                        <Card.Body>
                            ...
                            <Link style={{ marginLeft: '650px' }} to={`/${selectorTopicsDetail.courseTitle}/${topic.topicName}/addcontent/${topic.topicId}`}>Add Content</Link>
                        </Card.Body>
                    </Card>
                ))
            )}
